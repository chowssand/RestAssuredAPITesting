...
import static stepDefinitions.HelperMethods.getDayName;


public class Get_Weather_Steps extends ServiceHooks{

    @Given("^I like to holiday on \"([^\"]*)\"$")
    public void i_like_to_holiday_on(String name) {
        request = given().queryParams("city","Bondai Beach","key",APIKey);
    }
